...
return {
    ...
    config = function(_, opts)
        ...
        vim.cmd("hi @keyword.repeat guifg=#c586c0")
        vim.cmd("hi @keyword.operator guifg=#c586c0")
        vim.cmd("hi @keyword.conditional guifg=#c586c0")
        ...
        vim.cmd("hi @function.method guifg=#dcdcaa")
        vim.cmd("hi @function.method.call guifg=#dcdcaa")
        ...
        vim.cmd("hi @variable.parameter guifg=#9cdcfe")
        vim.cmd("hi @variable.member guifg=#9cdcfe")
